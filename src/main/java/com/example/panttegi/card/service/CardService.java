...
public class CardService {
    ...
    public PostCardResponseDto postCard(
            String title, String description, int position, LocalDateTime endAt, Long managerId, Long listId
    ) {

        User user = userRepository.findById(managerId).orElseThrow(() -> new CustomException(ErrorCode.NOT_FOUND));
