...
public class BoardRoleInterceptor implements HandlerInterceptor {
    ...
    private boolean hasAccessWorkspace(String email, Long workspaceId) {
        ...
        return member.getRole().equals(MemberRole.WORKSPACE) || member.getRole().equals(MemberRole.BOARD);
    }
}
